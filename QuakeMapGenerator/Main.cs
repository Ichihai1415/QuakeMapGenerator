        ...
        private void P2P_Tick(object sender, EventArgs e)
        {
            ...
            if (P2PQuake_json[0].Id != LatestEarthquakeID)
            {
                ...
                else if (P2PQuake_json[0].Issue.Type == "Foreign")
                {
                    ...
                    int LocX;
                    if (P2PQuake_json[0].Earthquake.Hypocenter.Longitude >= 0)
                    {
                        LocX = (int)(P2PQuake_json[0].Earthquake.Hypocenter.Longitude + 180) * 5;
                    }
                    else
                    {
                        LocX = (int)(180 - P2PQuake_json[0].Earthquake.Hypocenter.Longitude * -1) * 5;
                    }
                    int LocY;
                    if (P2PQuake_json[0].Earthquake.Hypocenter.Latitude >= 0)
                    {
                        LocY = (int)(90 - P2PQuake_json[0].Earthquake.Hypocenter.Latitude) * 5;
                    }
                    else
                    {
                        LocY = (int)(-P2PQuake_json[0].Earthquake.Hypocenter.Latitude + 90) * 5;
                    }
